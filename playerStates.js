import { Temp, Scoreboard, Estimation, Uniform, Exponential, Balloon, Visual } from "./challenge.js";
...
class State {
    constructor(state){
        this.state = state;
        this.values = ['Visual', 'Estimation', 'Estimation', 'Estimation', 'Estimation', 'Estimation', 'Estimation',
            'Exponential', 'Balloon', 'Uniform', 'Uniform', 'Uniform'
        ];
    }
...
export class ASSET0 extends State {
    ...
    enter() {
        ...
        } else if (assetName === 'Visual') {
            this.chosenAsset = new Visual();
        }
